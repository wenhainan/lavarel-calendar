...
use Wenhainan\LavarelCalendar\LavarelCalendar;
use Livewire\LivewireManager;
use Livewire\Testing\TestableLivewire;

class LavarelCalendarTest extends TestCase
{
    private function createComponent($parameters = []) : TestableLivewire
    {
        return app(LivewireManager::class)->test(LavarelCalendar::class, $parameters);
    }
