...
/**
 * Class LavarelCalendar
 * @package Wenhainan\LavarelCalendar
 ...
 */
class LavarelCalendar extends Component
{
    public $startsAt;
    public $endsAt;
    ...
    public function setupViews($calendarView = null,
                               ...
                               $afterCalendarView = null)
    {
        $this->calendarView = $calendarView ?? 'lavarel-calendar::calendar';
        $this->dayView = $dayView ?? 'lavarel-calendar::day';
        $this->eventView = $eventView ?? 'lavarel-calendar::event';
        $this->dayOfWeekView = $dayOfWeekView ?? 'lavarel-calendar::day-of-week';
